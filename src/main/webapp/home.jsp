      ...
      <div class="card-group">
        <div class="card">
          ...
          <div class="card-body" >
            ...
            <p class="card-text">Conforme suas medidas, nossos profissionais irão analisar de uma forma rápida e saudável para você emagrecer com saúde!</p>
        ...
        <div class="card" id="teste">
          ...
          <div class="card-body">
            <h5 class="card-title">Reeducação Alimentar</h5>
            <p class="card-text">Você anda comendo mal? Fale com algum dos nossos profissionais e ele lhe dará uma reconstrução alimentar conforme suas necessidades</p>
            <a href="#" class="btn btn-primary">Entre em contato</a>
          </div>
        </div>
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Não sabe o que é bom para sua saúde? Fale com nossos profissionais e descubra</p>
            <a href="#" class="btn btn-primary">Entre em contato</a>
          </div>
        </div>
      </div>  
