    ...
    <fieldset>
            ...
            <h3 class="fs-subtitle"></h3>
                        ...
                        <label for="sobrenome">Sobrenome:</label><input type="text" name="sobrenome" id="sobrenome"
                         placeholder="Insira seu sobrenome" required="required"
                        ...
                        <label for="cnpj">Cnpj:</label><input
                            ...
                            title="Siga o formato  XX. XXX. XXX/XXXX-XX." required="required"
                            value="<c:out value='${nutricionista.cnpj}'/>" name="cnpj" />
                            </p>
                            <p>
                        <label for="senha">Senha:</label><input type="password" placeholder="Senha" id="password" required
                            pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
                            title="Deve conter pelo menos um número e uma letra maiúscula e minúscula e pelo menos 8 ou mais caracteres"
                            required> 
                            </p>
                            <p>
                            <label for="senha">Confirmar Senha:</label><input type="password" placeholder="senha"
