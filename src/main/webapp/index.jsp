 ...
 <div class="tabordion">
  <section id="section1">
    ...
    <div class="items filled-items1">
        <h4> Nós da NutriTech, temos o objetivo de ajudar pessoas que buscam melhorar a sua saúde através de uma alimentação saudável.
        ...
        <h4>Trabalhando também com os guias alimentares que são opções práticas quando pensamos numa alimentação com qualidade, 
  ...
  <section id="section2">
    ...
    <label for="option2" class="trr"> Serviços  </label>
      ...
      <img src="em.jpg" class="card1-img-top" alt="..." width= 700 height= 500 border-radius= 20px;>
         <div class="card1-body" >
          ...
          <p class="card-text2">
              ...
              necessidade e individualidade de cada ser humano. E é assim, que o emagrecimento eficiente acontece. </p>
     </div>
     </div>
  ...
  <article> 
       ...
       <div class="card-wrap">
         <div class="card border-0 shadow card--welcome is-show" id="welcome">
           <div class="card-body">
            ...
            <p>Selecione a opção ideal para você</p> <br>
    ...
    <div class="card border-0 shadow card--register" id="register">
       <div class="card-body"> <br>
          <h2 class="card-title">CLÍNICA</h2> <br>
            <p class="card-text">Para se manter conectado<br/>Faça seu login</p> <br>
    ...
    <button class="btn btn-lg">Entrar</button>
      ...
      <div class="card border-0 shadow card--login" id="login">
       <div class="card-body">
        ...
        <p>Para se manter conectado <br/>Faça seu login</p> <br>
