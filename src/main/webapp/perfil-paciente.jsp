				...
				<article>
					<form action="">
						<div class="tr wwq">
							...
							<label class="label" for="input">Telefone Residencial</label> <input
								class="input e" id="phone" name="phone"
								onkeypress="mask(this, mphone);" onblur="mask(this, mphone);"
								maxlength="14" required /> <label class="label" for="input">Telefone
								Celular</label> <input class="input e" id="phone" name="phone"
								onkeypress="mask(this, mphone);" onblur="mask(this, mphone);"
								maxlength="15" required /> <label class="label" for="input">
								Cep</label> <input class="input e" name="cep" type="text" id="cep"
								class="mascCEP" value="" size="10" maxlength="9"
								onblur="pesquisacep(this.value);" required /></label> <label
								class="label" for="input"> Rua</label> <input class="input e"
								name="rua" type="text" id="rua" size="60" required /></label> <label
								class="label" for="input"> Numero</label> <input class="input e"
								name="numero" type="number" id="numero" required> <label
								class="label" for="input"> Bairro</label> <input class="input e"
								name="bairro" type="text" id="bairro" size="40" required /></label> <label
								class="label" for="input"> Cidade</label> <input class="input e"
								name="cidade" type="text" id="cidade" size="40" required /></label> <label
								class="label" for="input"> Estado</label> <input class="input e"
								name="uf" type="text" id="uf" size="2" required /></label><br />
							...
							<div class="modal fade" id="exampleModal" tabindex="-1"
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-body">Sua atualização está prestes a
											ser concluida. Suas informações estão certas?</div>
										<div class="modal-footer">
											<button type="button" class="btn btn-secondary"
												data-dismiss="modal">Fechar</button>
											<button type="submit" class="btn btn-primary">Salvar
			...
			<section id="section5">
				...
				<article>
					...
					<button type="button" id="botao" class="button" data-toggle="modal"
							data-target="#exampleModal">agendar minha consulta</button></a>
